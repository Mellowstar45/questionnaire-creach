...
const createFormSchema = (questions: Question[]) => {
  return z.object({
    email: questions.find((q) => q.questiontitle === "Email" && q.Show === 0)
      ...
      : z.string().email(),
    hobby: questions.find((q) => q.questiontitle === "Hobby" && q.Show === 0)
      ? z
          .enum(["Coding", "Gaming", "Sleeping"], {
            required_error: "You need to select an option.",
          })
          .optional()
      : z.enum(["Coding", "Gaming", "Sleeping"], {
          required_error: "You need to select an option.",
        }),
    bio: questions.find((q) => q.questiontitle === "Bio" && q.Show === 0)
      ? z
          .string()
          .min(10, {
    ...
    number: questions.find((q) => q.questiontitle === "Number" && q.Show === 0)
      ? z.number().gte(1).lte(10).optional()
      : z.number().gte(1).lte(10),
    languages: questions.find(
      (q) => q.questiontitle === "Languages" && q.Show === 0
    )
      ? z.array(optionSchema).min(1).optional()
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="my-4">
                        ...
                        <FormDescription>
                          Amongst these options. Which is your favorite thing to
                          do ?
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="my-4">
                        ...
                        <FormDescription>
                          From a rating from 1 to 10, how much do you like the
                          numerical world currently ?
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
